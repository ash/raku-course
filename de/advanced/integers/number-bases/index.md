...
Ein Integer-Literal muss nicht im Dezimalsystem geschrieben werden. Raku versteht die drei gaengigsten alternativen Zahlensysteme direkt, jedes mit einem eigenen Präfix:
...
Für jedes andere Zahlensystem verwende die Radix-Form `:base<number>`:
