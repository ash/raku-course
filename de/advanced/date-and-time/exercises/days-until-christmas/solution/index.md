...
1. Die Subtraktion eines `Date` von einem anderen gibt die Anzahl der Tage zwischen ihnen zurück — hier `181` — sodass kein manuelles Zählen der Tage in jedem Monat nötig ist. Das spätere Datum wird zuerst geschrieben, damit das Ergebnis positiv ist.
