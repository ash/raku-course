...
Neben dem Rendern kann ein Programm sein eigenes Pod auch **von innen** lesen, während es läuft. Die spezielle Variable `$=pod` enthält das Pod der aktuellen Datei als Liste von Block-Objekten, sodass ein Programm seine eigene Dokumentation inspizieren kann:
