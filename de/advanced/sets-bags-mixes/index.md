...
Obwohl fuenf Zahlen übergeben wurden, hat das Set nur drei Elemente, weil `1` und `2` mehr als einmal vorkamen.
...
Wenn du lieber reines ASCII verwenden moechtest, kann derselbe Operator als `(elem)` geschrieben werden:
