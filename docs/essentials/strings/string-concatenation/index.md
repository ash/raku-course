...
If you have two strings, you can join them together and get a new longer string. This action is called string concatenation. In Raku, you concatenate strings using—guess what?—the concatenation operator. This operator is a tilde: `~`. To concatenate two strings, put `~` between them:
