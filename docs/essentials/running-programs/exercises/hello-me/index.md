...
Create and run a program that prints a greeting with your name. Save the program in a file and run it from the command line. If you prefer, you can [run the program](/essentials/running-programs) online or directly from an IDE.
