...
The Raku programs are written as plain text and usually are kept in text files (the exception is the programs that you run online or in the command line or prepare to be executed via `EVAL` or some other rare cases).
